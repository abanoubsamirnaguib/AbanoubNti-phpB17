...
<body>
    <div class="card border-primary w-50 mx-auto my-5">
        <div class="card-body text-center  mx-auto">
            ...
            <p class="card-text text-capitalize text-success p-2 rounded border border-success">get the root of number </p>
            <div class="container w-75 ">
                <form method="post" class="mx-auto ">
                    ...
                    <div class="mb-3 row ">
                        <label for="inputName" class="col-sm-1-12 col-form-label"></label>
                        <div class="col-sm-1-12">
                            <input type="number" class="form-control text-center" name="power" id="number" placeholder="Power">
                        </div>
                    </div>

                    <div class="mb-3 row ">
                        <div class="offset-sm-2 col-sm-10">
                            <button type="submit" class="btn btn-outline-info text-capitalize"> Root</button>
                        </div>
                    </div>
                </form>
            </div>
